...
projects I've came up with. Server side is written in L<Mojolicious::Lite>.
...
L<http://github.com/vti/showmetheshell>

Some screenshots are available in the repo:

L<http://github.com/vti/showmetheshell/tree/master/screenshots>

B<Showmethedesktop>

A HTML5 Canvas VNC client.

L<http://github.com/vti/showmethedesktop>

When implementing this I've also written a Protocol::RFB module. That does the job.

L<http://github.com/vti/protocol-rfb>

B<Showmethedrawing>

A HTML5 Canvas simple colaboration drawing.

L<http://github.com/vti/showmethedrawing>

B<Mojomber>

A simple multiplayer Bomberman clone. Fun to play :)

L<http://github.com/vti/mojomber>

And BTW, L<Mojo::JSON::Any> speeds up everything.
