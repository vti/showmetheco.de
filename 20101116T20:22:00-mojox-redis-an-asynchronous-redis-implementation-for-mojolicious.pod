...
Author of this post is und3f, author of L<MojoX::Redis>. You can follow him on
Twitter L<http://twitter.com/und3f> and/or GitHub L<http://github.com/und3f>.

Today's topic is L<MojoX::Redis> module for L<Mojolicious> and asynchronous
commucation with Redis.

[cut]

Essentially Redis is a lightweight but advanced key-value store with great
possibilities. It is available from L<http://code.google.com/p/redis/>. Redis is
...
L<http://code.google.com/p/redis/wiki/ProtocolSpecification>. Commands within
...
Here are some examples of using L<MojoX::Redis> from a real life application. It
