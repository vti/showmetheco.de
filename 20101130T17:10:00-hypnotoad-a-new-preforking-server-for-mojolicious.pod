...
(L<http://showmetheco.de/articles/2010/11/timtow-to-build-a-websocket-server-in-perl.html>),
preforking should be done with care and quality that L<Mojolicious> always brings to you.
...
Check it out on GitHub L<http://github.com/kraih/mojo>!
