...
=item * extracted distributions from L<http://backpan.perl.org>

=item * used awesome Gource L<http://code.google.com/p/gource> software for video generation

=item * added music and text
