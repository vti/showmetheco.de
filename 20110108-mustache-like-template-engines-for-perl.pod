...
I am used to L<Mojo::Template>. But I noticed that I keep improving the template
...
mustache L<http://mustache.github.com> and it is available for various languages
including Perl (L<https://github.com/pvande/Template-Mustache>).

And I couldn't resist from implementing one more version too
L<http://github.com/vti/text-caml> :)
