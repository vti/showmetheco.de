...
First I tried using L<Net::Amazon> but it didn't worked very well for paging, so
...
Sinatra and so on). Then prepared data for C<gnuplot>.
...
L<https://gist.github.com/3048049>.
